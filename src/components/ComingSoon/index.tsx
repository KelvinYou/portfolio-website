...
const ComingSoon: React.FC<ComingSoonProps> = ({ title }) => {
  ...
  const shareToWhatsApp = () => {
    const text = `oi please complete your ${title || ""} page fast fast leh !`;
  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col items-center justify-center text-center px-4">
      ...
      <div className='flex items-center justify-center text-white gap-2 cursor-pointer hover:text-on-primary' onClick={shareToWhatsApp}>
        ...
        <p>
          Click here to tell me I have to do it faster
        </p>
